...
class Setup(object):
    ...
    __slots__ = 'form2idx', 'lemm2idx', 'upos2idx', 'drel2idx', 'feat2idx', \
                'idx2tran', \
                'form_emb', 'lemm_emb', 'x', 'y'
    ...
    @staticmethod
    def make(train_conllu, form_emb_txt, lemm_emb_txt, proj=False):
        """-> Setup; from files"""
        return Setup.cons(
            load(train_conllu),
            KeyedVectors.load_word2vec_format(form_emb_txt),
            KeyedVectors.load_word2vec_format(lemm_emb_txt),
            proj=proj)
...
# train_path = ud_path + "UD_{}/{}-ud-train.conllu" \
#              .format(treebanks[lang], lang)
# form_emb_path = "./embed/{}-form.w2v".format(lang)
# lemm_emb_path = "./embed/{}-lemm.w2v".lemmat(lang)
# setup = Setup.make(train_path, form_emb_path, lemm_emb_path, proj)
